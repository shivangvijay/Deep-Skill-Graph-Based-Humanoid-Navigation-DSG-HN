...
AbstractedState DeepSkillGraph::_runMPC(const AbstractedState &target)
{
    ...
    for (int step = 0; step < _cfg.mpc_steps; ++step)
    {
        ...
        auto plan = randomShootMPC(
            ...
            goal_x, goal_y,
            _cfg.mpc_horizon, _cfg.mpc_candidates, _cfg.mpc_action_limits,
            _cfg.mpc_base_radius, _cfg.mpc_clearance,
            _cfg.mpc_collision_penalty, _cfg.mpc_action_penalty,
            _cfg.mpc_smoothness_penalty, _cfg.mpc_goal_weight,
